 ...
 */
class ApplicationService extends Developer\ApplicationService
{
    /**
     * Map of license names to their corresponding class names
     */
    private static $licenseClassMap = [
        LicenceConstants::LITE => 'AmeliaBooking\Infrastructure\Licence\Lite\ApplicationService',
        LicenceConstants::STARTER => 'AmeliaBooking\Infrastructure\Licence\Starter\ApplicationService',
        LicenceConstants::BASIC => 'AmeliaBooking\Infrastructure\Licence\Basic\ApplicationService',
        LicenceConstants::PRO => 'AmeliaBooking\Infrastructure\Licence\Pro\ApplicationService',
        LicenceConstants::DEVELOPER => 'AmeliaBooking\Infrastructure\Licence\Developer\ApplicationService',
    ];
    ...
    private static function getLicenseClass()
    {
        ...
        if (AMELIA_PRODUCTION) {
            return 'AmeliaBooking\Infrastructure\Licence\Developer\ApplicationService';
        }
        ...
        return self::$licenseClassMap[$currentLicense] ?? 'AmeliaBooking\Infrastructure\Licence\Developer\ApplicationService';
    }
