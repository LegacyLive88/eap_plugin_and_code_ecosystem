 ...
 */
class DomainService extends Developer\DomainService
{
    /**
    ...
    private static $licenseClassMap = [
        ...
        LicenceConstants::DEVELOPER => 'AmeliaBooking\Infrastructure\Licence\Developer\DomainService',
    ];
    ...
    private static function getLicenseClass()
    {
        ...
        if (AMELIA_PRODUCTION) {
            return 'AmeliaBooking\Infrastructure\Licence\Developer\DomainService';
        }
        ...
        return self::$licenseClassMap[$currentLicense] ?? 'AmeliaBooking\Infrastructure\Licence\Developer\DomainService';
    }
